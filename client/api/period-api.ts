...
export const PeriodApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        periodControllerGetPeriods: async (projectId: string, sortDirection: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const PeriodApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async periodControllerGetPeriods(projectId: string, sortDirection: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.periodControllerGetPeriods(projectId, sortDirection, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const PeriodApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        periodControllerGetPeriods(projectId: string, sortDirection: string, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.periodControllerGetPeriods(projectId, sortDirection, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {string} periodId 
...
export class PeriodApi extends BaseAPI implements PeriodApiInterface {
     ...
     * @memberof PeriodApi
     */
    public periodControllerGetPeriods(projectId: string, sortDirection: string, options?: RawAxiosRequestConfig) {
        return PeriodApiFp(this.configuration).periodControllerGetPeriods(projectId, sortDirection, options).then((request) => request(this.axios, this.basePath));
    }
